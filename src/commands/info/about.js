...
module.exports = {
    ...
    run : async(client,message,args,prefix) => {
        ...
        .addFields([
	    {name : `${client.emoji.owner} Owners`,value : `[ItzJarvis#9999](${client.config.support_server_link})` , inline : true},
            {name : `${client.emoji.verified_bot_developer} Developer`,value : `ItzJarvis#9999\n[~ Punit_xD 🥀#5834](https://instagram.com/_.punnii._)` , inline : true},
            {
                name : `Importants`,
